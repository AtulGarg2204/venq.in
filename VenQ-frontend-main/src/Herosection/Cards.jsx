...
const Cards = () => {
  return (
    <div className='w-full font-raleway  md:h-[vw] 2xl:h-[30vw] mt-[8vw] p-[5vw] md:flex justify-center items-center gap-[4vw]'>
      <div className="2xl:w-[20vw] mb-[5vw] md:w-[25vw] md:h-[30vw] 2xl:h-[22vw]  relative p-6  bg-zinc-100 rounded-3xl flex flex-col justify-center items-center">
