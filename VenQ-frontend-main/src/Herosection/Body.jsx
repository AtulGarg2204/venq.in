              ...
              <div className='w-full h-full z-10 top-0 left-0 absolute'>
                <div className="w-full font-raleway p-[4vw] md:p-[2vw] h-full ">
                  <div className="flex font-raleway overflow-hidden w-full items-center flex-col">
                    ...
                    <h1 ref={Bodytext} className='2xl:text-[90px] pt-[7vw] mt-[15vw] md:mt-[2vw] text-[30px] leading-[30px] 2xl:mt-[2vw] md:text-[45px] tracking md:leading-[45px] text-zinc-50 2xl:leading-[85px] font-bold text-center font-raleway'>Invest in Real Estate <br /> Smarter & Simpler</h1>
                    <h1 ref={bodytextsmall} className='2xl:mt-8 mt-5 md:px-[0rem] px-[2rem] md:mt-8 text-center text-zinc-400 text-sm md:text-xl 2xl:text-xl font-medium'>Your Gateway to property ownership-start with just RS 5000</h1>
                    <div className="flex mt-6 justify-center items-center gap-5">
                      <button className='2xl:py-2.5 2xl:px-10 md:py-2.5 text-xs md:text-lg md:px-10 px-[1.5rem] rounded-full bg-white text-black font-semibold
                        hover:text-white hover:bg-zinc-800
               transition-all duration-300 ease-in-out 
               transform hover:scale-105 hover:translate-y-[-3px]
                      '>Invest Now</button>
                      <button className='2xl:py-2.5 2xl:px-10 text-xs md:text-lg  md:py-2.5 md:px-10 rounded-full bg-black text-white font-semibold
