            ...
            <div className='w-full h-full'>
                <div className="w-full font-raleway p-[2vw] h-full ">
                  <div className="flex font-raleway overflow-hidden w-full items-center flex-col">
                    ...
                    <h1 className='2xl:text-[90px] py-[7vw] md:mt-[2vw] text-[35px] 2xl:mt-[2vw] md:text-[45px] tracking md:leading-[45px] text-zinc-50 2xl:leading-[85px] font-bold text-center font-raleway'>Invest in Real Estate <br /> Smarter & Simpler</h1>
                    <h1 className='2xl:mt-8 md:mt-8 text-center text-zinc-400 2xl:text-xl font-medium'>Your Gateway to property ownership-start with just RS 5000</h1>
                    <div className="flex mt-10 justify-center items-center gap-5">
                      <button className='2xl:py-2.5 2xl:px-10 md:py-2.5 md:px-10 rounded-full bg-white text-black font-semibold'>Invest Now</button>
                      <button className='2xl:py-2.5 2xl:px-10 md:py-2.5 md:px-10 rounded-full bg-black text-white font-semibold'>Learn More </button>
                    </div> 
                  </div>
                </div>
              </div>
