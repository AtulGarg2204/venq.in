...
const MainScreen = ({ handleCart, clicked, setClicked }) => {
      ...
      >
        ...
        >
          <Details>
            ...
            >
              {listing.propertydescription ? (
                listing.propertydescription.split("|").map((part, index) => (
          ...
          >
            ...
            >
              <ImageList
                sx={{ width: "100%", height: { xs: 300, sm: 400, md: 520 } }} // Responsive height
                variant="quilted"
                cols={4} // 4 columns total
                rowHeight={260} // Consistent height for rows
              >
                {listing.images &&
                  listing.images.slice(0, 3).map((item, index) => (
                    <ImageListItem
                      key={index}
                      cols={index === 0 ? 2 : 2} // First image takes 2 columns, the rest 2 columns each
                      rows={index === 0 ? 2 : 1} // First image takes 2 rows, the rest 1 row each
                    >
                      <img
                        style={{
                          borderRadius: "10px",
