    ...
    <div className="rectangle-box">
      ...
      <div className="progress-container">
        <div className="step-labels">
          <span className={`step-label ${progress >= 1 ? 'active' : ''}`}>Not Started</span>
          <span className={`step-label ${progress >= 2 ? 'active' : ''}`}>Pending</span>
          <span className={`step-label ${progress >= 3 ? 'active' : ''}`}>Completed</span>
        </div>
